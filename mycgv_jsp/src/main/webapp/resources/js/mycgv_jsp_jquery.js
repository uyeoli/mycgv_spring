	...
	$("#btnIdCheck").click(function(){
		...
		if($("#id").val() == "") {
			...
			$.ajax({
				...
				success : function(result) { // String타입으로 보냈어도 스크립트로 넘어올때는 숫자로 인식
					if(result == 0) {
						$("#idcheck_msg").text("사용가능한 아이디입니다.").css("color","blue")
						.css("font-size","11px").css("display","block").css("padding", "5px 0");
						$("#pass").focus();
					} else {
